...
def build_sequence_data(proteins, sequence_length):
    ...
    for p in proteins:
        ...
        obj.append((features, label, meta_data, residue_label, cleavage_site, db, one_hot_label))
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        print('Usage: ./build_train_features.py [dataset name]')
        print()
    ...
    np.save(output_dir + 'eval.npy', eval_data)
